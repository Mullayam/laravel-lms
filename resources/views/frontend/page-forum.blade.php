            ...
            <ul class="card divide-y divide-gray-100 sm:m-0 -mx-5">
                <li>
                    <div class="flex items-start space-x-5 p-7">
                        ...
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1 mb-1">I have only recently found
                                this particular keyword. </a>
                            <p class="text-sm text-gray-400 mb-2"> Posted By: <span
                                    data-href="%40tag-dev.html">Tag-dev</span> 8 hours ago</span> </p>
                            <p class="leading-6 line-clamp-2 mt-3">Lorem ipsum dolor sit amet, consectetuer
                ...
                <li>
                    <div class="flex items-start space-x-5 p-7">
                        ...
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1 mb-1"> Stuck on Please wait for
                                hosting to be configured </a>
                            <p class="text-sm text-gray-400 mb-2"> Posted By: <span
                                    data-href="%40tag-dev.html">Tag-dev</span> 8 hours ago</span> </p>
                            <p class="leading-6 line-clamp-2 mt-3">Lorem ipsum dolor sit amet, consectetuer
                                adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna
                ...
                <li>
                    <div class="flex items-start space-x-5 p-7">
                        ...
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1 mb-1"> Messing around with it, one
                                use I found is by overriding </a>
                            <p class="text-sm text-gray-400 mb-2"> Posted By: <span
                                    data-href="%40tag-dev.html">Tag-dev</span> 8 hours ago</span> </p>
                            <p class="leading-6 line-clamp-2 mt-3">Lorem ipsum dolor sit amet, consectetuer
                                adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna
            ...
            <ul class="card divide-y divide-gray-100">
                <li>
                    <div class="flex items-center space-x-5 p-7">
                        <img src="../assets/images/avatars/avatar-1.jpg" alt="" class="w-12 h-12 rounded-full">
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1"> Recommendations for new computer
                            </a>
                        ...
                        <div class="sm:flex items-center -space-x-4 hidden">
                            ...
                            <img src="../assets/images/avatars/avatar-3.jpg" alt=""
                                ...
                                title="Adrian Mohani">
                            <div
                                class="w-10 h-10 rounded-full flex justify-center items-center bg-red-100 text-red-500 font-semibold">
                                12+</div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="flex items-center space-x-5 p-7">
                        <img src="../assets/images/avatars/avatar-2.jpg" alt="" class="w-12 h-12 rounded-full">
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1"> Once more about streaks </a>
                            <div class="flex space-x-3 text-sm pb-2 flex-wrap">
                                <a href="timeline.html" class="font-semibold"> Adrian Mohani </a>
                                <div class="text-gray-500"> Oct 20Th , 2020 </div>
                                <div class="text-gray-500"> 12 replies</div>
                            </div>
                        </div>
                        <div class="sm:flex items-center -space-x-4 hidden">
                            ...
                            <img src="../assets/images/avatars/avatar-4.jpg" alt=""
                                ...
                                title="Stella Johnson">
                            <div
                                class="w-10 h-10 rounded-full flex justify-center items-center bg-green-100 text-green-500 font-semibold">
                                12+</div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="flex items-center space-x-5 p-7">
                        ...
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1"> Stuck on Please wait for hosting
                                to be configured </a>
                            <div class="flex space-x-3 text-sm pb-2 mt-1 flex-wrap font-medium">
                                <a href="timeline.html" class="font-semibold"> Stella Johnson </a>
                                <div class="text-gray-500"> Oct 20Th , 2020 </div>
                                <div class="text-gray-500"> 12 replies</div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="flex items-center space-x-5 p-7">
                        <img src="../assets/images/avatars/avatar-2.jpg" alt="" class="w-12 h-12 rounded-full">
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1"> Messing around with it, one use
                                I found is by overriding </a>
                            <div class="flex space-x-3 text-sm pb-2 mt-1 flex-wrap font-medium">
                        ...
                        <div class="sm:flex items-center -space-x-4 hidden">
                            <img src="../assets/images/avatars/avatar-5.jpg" alt=""
                                ...
                                data-tippy-placement="top" title="Adrian Mohani">
                            <img src="../assets/images/avatars/avatar-6.html" alt=""
                                class="w-10 h-10 rounded-full border-2 border-white" data-tippy-placement="top"
                                title="Jesse Stevens">
                            <img src="../assets/images/avatars/avatar-2.jpg" alt=""
                                class="w-10 h-10 rounded-full border-2 border-white" data-tippy-placement="top"
